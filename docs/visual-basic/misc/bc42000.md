...
---
# <a name="type-methodname-conflicts-with-other-members-of-the-same-name-across-the-inheritance-hierarchy-and-so-should-be-declared-shadows"></a>\<type> '\<methodname>' は、継承階層間で同じ名前の他のメンバーと競合しているため、'Shadows' と宣言する必要があります
