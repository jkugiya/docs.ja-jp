...
---
# <a name="type-argument-inference-failed-for-type-parameter-typeparametername1-of-genericproceduresignature"></a>'\<genericproceduresignature>' の型パラメーター '\<typeparametername1>' に対する型引数の推定に失敗しました

'\<genericproceduresignature>' の型パラメーター '\<typeparametername1>' に対する型引数の推定に失敗しました。 パラメーター '\<parametername1>' に渡された引数から推論される型引数が、パラメーター '\<parametername2>' に渡された引数から推論される型引数と競合しています。  
