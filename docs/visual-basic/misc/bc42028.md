...
- [Static](../language-reference/modifiers/static.md)  
 ...
 さらに、モジュールのステートメント ブロック内で [Implements](../language-reference/statements/implements-clause.md) ステートメントも [Inherits ステートメント](../language-reference/statements/inherits-statement.md)も使用することはできません。  
