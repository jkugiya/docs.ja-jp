...
---
# <a name="cannot-inherit-interface-interfacename1-because-the-interface-interfacename2-from-which-it-inherits-could-be-identical-to-interface-interfacename3-for-some-type-arguments"></a>詳細情報: インターフェイス '\<interfacename1>' を継承できません。継承元であるインターフェイス '\<interfacename2>'の一部の型引数が、インターフェイス '\<interfacename3>' と同一である可能性があります。
