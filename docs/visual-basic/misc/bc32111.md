...
---
# <a name="indirect-constraint-constraint1-obtained-from-the-type-parameter-constraint-typeparameter1-conflicts-with-the-constraint-constraint2"></a>型パラメーター制約 '\<typeparameter1>' から取得された間接的な制約 '\<constraint1>' は、制約 '\<constraint2>' と競合しています
