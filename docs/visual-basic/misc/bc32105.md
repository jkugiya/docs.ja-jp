...
---
# <a name="type-argument-typeargumentname-does-not-satisfy-the-structure-constraint-for-type-parameter-typeparametername"></a>型引数 '\<typeargumentname>' が型パラメーター '\<typeparametername>' の 'Structure' 制約を満たしていません
