...
---
# <a name="procedurename1-cannot-override-procedurename2-because-they-differ-by-parameters-declared-paramarray"></a>'ParamArray' として宣言されたパラメーターが異なるため、'\<procedurename1>' で '\<procedurename2>' をオーバーライドすることはできません
