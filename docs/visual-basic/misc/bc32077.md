...
---
# <a name="procedurename-cannot-override-baseprocedurename-because-they-differ-by-type-parameter-constraints"></a>型パラメーターの制約が異なるため、'\<procedurename>' で '\<baseprocedurename>' をオーバーライドすることはできません
