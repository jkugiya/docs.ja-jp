...
---
# <a name="sample-xml-file-multiple-purchase-orders-in-a-namespace-linq-to-xml"></a>サンプル XML ファイル: 名前空間内の複数の購買発注書 (LINQ to XML)

次の XML ファイルは、LINQ to XML ドキュメントのさまざまな例で使用されます。 このファイルには、複数の購買発注書が含まれています。 XML は名前空間に含まれています。
