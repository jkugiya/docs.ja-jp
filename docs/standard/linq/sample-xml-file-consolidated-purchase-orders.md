...
---
# <a name="sample-xml-file-consolidated-purchase-orders-linq-to-xml"></a>サンプル XML ファイル: 統合購買発注書 (LINQ to XML)

次の XML ファイルは、LINQ to XML ドキュメントのさまざまな例で使用されます。 このファイルは、形式の異なる複数企業の購買発注書をまとめたものです。 各企業の購買発注書は、別々の名前空間に含まれています。
