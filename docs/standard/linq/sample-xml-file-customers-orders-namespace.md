---
title: 'サンプル XML ファイル: 名前空間内の顧客と注文 - LINQ to XML'
description: (例で使用されている) この XML ファイルには、顧客と注文に関する名前空間のデータが含まれています。
ms.date: 07/20/2015
...
ms.locfileid: "103412068"
---
# <a name="sample-xml-file-customers-and-orders-in-a-namespace-linq-to-xml"></a><span data-ttu-id="12d7f-103">サンプル XML ファイル: 名前空間内の顧客と注文 (LINQ to XML)</span><span class="sxs-lookup"><span data-stu-id="12d7f-103">Sample XML file: Customers and orders in a namespace (LINQ to XML)</span></span>

<span data-ttu-id="12d7f-104">次の XML ファイルは、LINQ to XML ドキュメントのさまざまな例で使用されます。</span><span class="sxs-lookup"><span data-stu-id="12d7f-104">The following XML file is used in various examples in the LINQ to XML documentation.</span></span> <span data-ttu-id="12d7f-105">このファイルには顧客と注文が含まれています。</span><span class="sxs-lookup"><span data-stu-id="12d7f-105">This file contains customers and orders.</span></span> <span data-ttu-id="12d7f-106">XML は名前空間に含まれています。</span><span class="sxs-lookup"><span data-stu-id="12d7f-106">The XML is in a namespace.</span></span>

## <a name="customersordersinnamespacexml"></a><span data-ttu-id="12d7f-107">CustomersOrdersInNamespace.xml</span><span class="sxs-lookup"><span data-stu-id="12d7f-107">CustomersOrdersInNamespace.xml</span></span>
