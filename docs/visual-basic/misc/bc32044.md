...
---
# <a name="type-argument-typeargumentname-does-not-inherit-from-or-implement-the-constraint-type-typeparametername"></a>型引数 '\<typeargumentname>' は、制約型 '\<typeparametername>' から継承することも、この型を実装することもありません
