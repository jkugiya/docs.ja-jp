...
`ReadOnly` プロパティの宣言では、[プロパティ ステートメント](../language-reference/statements/property-statement.md)と [Get ステートメント](../language-reference/statements/get-statement.md)の両方でアクセス レベルを指定します。  
