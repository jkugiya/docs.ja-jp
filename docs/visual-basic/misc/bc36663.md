...
---
# <a name="option-strict-on-does-not-allow-narrowing-in-implicit-type-conversions-between-method-methodname-and-delegate-delegatename"></a>Option Strict On では、メソッド '\<methodname>' とデリゲート '\<delegatename>' の間の暗黙的な型変換で縮小変換は許可されません
