---
title: オブジェクト グラフを射影する方法 - LINQ to XML
description: C# または Visual Basic を使用して、XML からオブジェクト グラフを射影または設定できます。 この記事の例は、その方法を示します。
ms.date: 07/20/2015
dev_langs:
- csharp
- vb
...
ms.locfileid: "103412085"
---
# <a name="how-to-project-an-object-graph-linq-to-xml"></a><span data-ttu-id="b724e-104">オブジェクト グラフを射影する方法 (LINQ to XML)</span><span class="sxs-lookup"><span data-stu-id="b724e-104">How to project an object graph (LINQ to XML)</span></span>

<span data-ttu-id="b724e-105">C# または Visual Basic を使用して、XML からオブジェクト グラフを射影または設定できます。</span><span class="sxs-lookup"><span data-stu-id="b724e-105">You can use C# or Visual Basic to project or populate an object graph from XML.</span></span>

## <a name="example-populate-an-object-graph-from-xml"></a><span data-ttu-id="b724e-106">例: XML からオブジェクト グラフを設定する</span><span class="sxs-lookup"><span data-stu-id="b724e-106">Example: Populate an object graph from XML</span></span>

<span data-ttu-id="b724e-107">この例では、「[サンプル XML ファイル: 一般的な購買発注書](sample-xml-file-typical-purchase-order.md)」の XML ドキュメントから、`Address`、`PurchaseOrder`、`PurchaseOrderItem` の各クラスを使用して、オブジェクト グラフを設定します。</span><span class="sxs-lookup"><span data-stu-id="b724e-107">This example populates an object graph with the `Address`, `PurchaseOrder`, and `PurchaseOrderItem` classes from XML document [Sample XML file: Typical purchase order](sample-xml-file-typical-purchase-order.md).</span></span>
...
<span data-ttu-id="b724e-108">LINQ クエリの結果は、`PurchaseOrderItem` の <xref:System.Collections.Generic.IEnumerable%601> として返されます。</span><span class="sxs-lookup"><span data-stu-id="b724e-108">The result of the LINQ query is returned as an <xref:System.Collections.Generic.IEnumerable%601> of `PurchaseOrderItem`.</span></span> <span data-ttu-id="b724e-109">`PurchaseOrder` クラスの項目は、<xref:System.Collections.Generic.IEnumerable%601> の `PurchaseOrderItem` 型です。</span><span class="sxs-lookup"><span data-stu-id="b724e-109">The items in the `PurchaseOrder` class are of type <xref:System.Collections.Generic.IEnumerable%601> of `PurchaseOrderItem`.</span></span> <span data-ttu-id="b724e-110">このコードでは、<xref:System.Linq.Enumerable.ToList%2A> 拡張メソッドを使用して、クエリの結果から <xref:System.Collections.Generic.List%601> コレクションを作成します。</span><span class="sxs-lookup"><span data-stu-id="b724e-110">The code uses the <xref:System.Linq.Enumerable.ToList%2A> extension method to create a <xref:System.Collections.Generic.List%601> collection from the results of the query.</span></span>

<span data-ttu-id="b724e-111">この例を実行すると、次の出力が生成されます。</span><span class="sxs-lookup"><span data-stu-id="b724e-111">This example produces the following output:</span></span>
...
## <a name="see-also"></a><span data-ttu-id="b724e-112">関連項目</span><span class="sxs-lookup"><span data-stu-id="b724e-112">See also</span></span>
