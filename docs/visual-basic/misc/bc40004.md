...
---
# <a name="type1-membername-conflicts-with-type2-membername-on-the-base-class-type3-classname-and-should-be-declared-shadows"></a>\<type1> '\<membername>' は、基底クラス \<type3> '\<classname>' の \<type2> '\<membername>' と競合しています。'Shadows' として宣言する必要があります
