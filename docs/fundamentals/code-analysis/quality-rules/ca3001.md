...
## <a name="configure-code-to-analyze"></a><span data-ttu-id="1395a-128">分析するコードの構成</span><span class="sxs-lookup"><span data-stu-id="1395a-128">Configure code to analyze</span></span>
