...
## <a name="prerequisites"></a><span data-ttu-id="af602-114">必須コンポーネント</span><span class="sxs-lookup"><span data-stu-id="af602-114">Prerequisites</span></span>
