...
---
# <a name="type-argument-typeargumentname-is-declared-mustinherit-and-does-not-satisfy-the-new-constraint-for-type-parameter-typeparametername"></a>型引数 '\<typeargumentname>' は 'MustInherit' として宣言され、型パラメーター '\<typeparametername>' の 'New' 制約を満たしていません
