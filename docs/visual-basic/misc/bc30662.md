...
---
# <a name="attribute-attributename-cannot-be-applied-to-membername-because-the-attribute-is-not-valid-on-this-declaration-type"></a>属性 '\<attributename>' を '\<membername>' に適用できません。この属性はこの型の宣言では有効ではありません。
