...
---
# <a name="sample-xml-file-customers-and-orders-in-a-namespace-linq-to-xml"></a>サンプル XML ファイル: 名前空間内の顧客と注文 (LINQ to XML)

次の XML ファイルは、LINQ to XML ドキュメントのさまざまな例で使用されます。 このファイルには顧客と注文が含まれています。 XML は名前空間に含まれています。
