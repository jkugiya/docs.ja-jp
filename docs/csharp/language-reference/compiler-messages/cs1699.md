...
- <xref:System.Reflection.AssemblyKeyFileAttribute> 属性の代わりに [**KeyFile** (C# コンパイラ オプション)](../compiler-options/security.md#keyfile)。  
  
- <xref:System.Reflection.AssemblyKeyNameAttribute> の代わりに [**KeyContainer** (C# コンパイラ オプション)](../compiler-options/security.md#keycontainer)。  
  
- <xref:System.Reflection.AssemblyDelaySignAttribute> の代わりに [**DelaySign** (C# コンパイラ オプション)](../compiler-options/security.md#delaysign)。  
