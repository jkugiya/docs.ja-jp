...
---
# <a name="type1-membername-shadows-an-overloadable-member-declared-in-the-base-type2-classname"></a>\<type1> '\<membername>' は、基本 \<type2> '\<classname>' で宣言されているオーバーロード可能なメンバーをシャドウしています

\<type1> '\<membername>' は、基本 \<type2> '\<classname>' で宣言されているオーバーロード可能なメンバーをシャドウしています。 ベース メソッドをオーバーロードするには、このメソッドは 'Overloads' に宣言されている必要があります。  
