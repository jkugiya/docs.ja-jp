...
---
# <a name="cannot-implement-interfacename1membername-because-its-implementation-could-conflict-with-the-implementation-for-interfacename2membername-for-some-type-arguments"></a>実装すると '\<interfacename2>.\<membername>' の実装と型引数が競合する可能性があるため、'\<interfacename1>.\<membername>' を実装できません
