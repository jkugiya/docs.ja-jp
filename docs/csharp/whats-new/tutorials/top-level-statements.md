...
## <a name="build-a-magic-net-answer-machine"></a><span data-ttu-id="e9413-127">マジック .NET 回答マシンをビルドする</span><span class="sxs-lookup"><span data-stu-id="e9413-127">Build a magic .NET answer machine</span></span>
