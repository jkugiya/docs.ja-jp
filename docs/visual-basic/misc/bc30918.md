...
---
# <a name="class-classname-must-declare-a-sub-new-because-the-constructorname-in-its-base-class-baseclassname-is-marked-obsolete-errormessage"></a>基底クラス'\<baseclassname>' の '\<constructorname>' が古い形式とマークされているため、クラス '\<classname>' は 'Sub New' を宣言しなければなりません: '\<errormessage>'
